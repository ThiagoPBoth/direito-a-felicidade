...
public class WebServiceController extends AppCompatActivity {
    String urlWebServicesDesenvolvimento = "http://192.168.15.147:80/projetoAndroid/";// O número deve ser o IPV4 de cada um
    ...
    public void carregaAplicativos(final VolleyResponseListner volleyResponseListner)
    {
    ...
    public void carregaCanais(final String filtroCodTematica, final VolleyResponseListner volleyResponseListner) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urlWebServicesDesenvolvimento + "getCanal.php",
            ...
            protected Map<String, String> getParams() {
                Map<String, String> params = new HashMap<>();
                params.put("filtroCodTematica", filtroCodTematica);
                return params;
            }
        };
    ...
    public void carregaSeries(final VolleyResponseListner volleyResponseListner) {
        RequestQueue requestQueue = Volley.newRequestQueue(context);
    ...
    public void carregaSites(final VolleyResponseListner volleyResponseListner) {
        RequestQueue requestQueue = Volley.newRequestQueue(context);
    ...
    public void carregaEventos(final VolleyResponseListner volleyResponseListner) {
        RequestQueue requestQueue = Volley.newRequestQueue(context);
    ...
    public void carregaLivros(final VolleyResponseListner volleyResponseListner) {
        RequestQueue requestQueue = Volley.newRequestQueue(context);
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
    ...
    public void carregaFilmes(final  VolleyResponseListner volleyResponseListner) {
        RequestQueue requestQueue = Volley.newRequestQueue(context);
    ...
    public void carregaArtigos(final VolleyResponseListner volleyResponseListner) {

        listaArtigos = new ArrayList<>();
        RequestQueue requestQueue = Volley.newRequestQueue(context);

        StringRequest stringRequest = new StringRequest(Request.Method.POST, urlWebServicesDesenvolvimento + "teste.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
